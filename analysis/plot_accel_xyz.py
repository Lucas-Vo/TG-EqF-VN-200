...
def main() -> None:
    ...
    add_comparison_line(axes[0], vn_data, tgeqf_data, "accel_x", "x")
    add_comparison_line(axes[1], vn_data, tgeqf_data, "accel_y", "y")
    add_comparison_line(axes[2], vn_data, tgeqf_data, "accel_z", "z")
